...
contract DeployOnL1 is Script {
    ...
    function run() external {
        ...
        //         abi.encode(addressManagerProxy, "Taiko Token Eldfell",
        // "TTKOe")
        //     )
        // );

        // // HorseToken && BullToken
        // address horseToken = address(new FreeMintERC20("Horse Token",
        // "HORSE"));
        ...
        //     "bridge",
        //     address(bridge),
        //     bytes.concat(bridge.init.selector,
    ...
    //     assembly {
    //         deployedAddress := create(0, add(bytecode, 0x20),
    // mload(bytecode))
    //     }
    ...
    //     if (addr != address(0)) {
    //         AddressManager(addressManagerProxy).setAddress(chainId, name,
    // addr);
    //     }
    // }
}
