...
The bridge is a set of smart contracts that allow you to send ETH and ERC-20, ERC-1155 and ERC-721 tokens between Sepolia and Taiko. This bridge is just one possible implementation built on top of Taiko's core protocol, specifically the signal service which anybody can use to build bridges.


### Bridging ETH

![bridging send message flowchart](/images/diagrams/concepts/bridging/bridging-send-message.excalidraw.svg) \
![bridging process message flowchart](/images/diagrams/concepts/bridging/bridging-process-message.excalidraw.svg)
...
It is possible to bridge tokens and ETH in one transaction.
